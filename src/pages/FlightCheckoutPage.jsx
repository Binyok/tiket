...
const FlightCheckoutPage = () => {
  ...
  const { flight, selectedClass, passengers = 1, date } = state;
      ...
      <div className="bg-gray-50 min-h-screen flex items-center justify-center">
        <div className="bg-white rounded-xl shadow-md p-8 max-w-md text-center">
          <p className="text-gray-700 mb-4">
            Data pemesanan penerbangan tidak ditemukan. Silakan pilih penerbangan terlebih dahulu.
          </p>
          <button
            className="btn-primary"
            onClick={() => navigate('/flights')}
          >
            Kembali ke Pencarian Penerbangan
          </button>
        </div>
      </div>
    );
  ...
  const basePricePerPassenger = selectedClass.price || 0;
  const subtotal = basePricePerPassenger * passengerCount;
  const tax = Math.round(subtotal * 0.1); // 10% dari subtotal
  const serviceFee = 25000;
  const totalPrice = subtotal + tax + serviceFee;

  const bookingDetails = {
    type: 'Pesawat',
    route: `${flight.departure.city} (${flight.departure.airport}) - ${flight.arrival.city} (${flight.arrival.airport})`,
    ...
    <div className="bg-gray-50 min-h-screen py-8">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Checkout Penerbangan</h1>
            <p className="text-gray-600">Lengkapi pembayaran untuk menyelesaikan pemesanan penerbangan Anda</p>
          </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-md p-6 sticky top-24">
                ...
                <div className="space-y-3 mb-6 pb-6 border-b">
                  ...
                  <div className="flex items-start justify-between">
                    <span className="text-sm text-gray-600">Maskapai</span>
                    <span className="text-sm font-medium text-gray-900">{bookingDetails.airline}</span>
                  </div>
                  <div className="flex items-start justify-between">
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-medium text-gray-900">
                      {formatPrice(bookingDetails.price * bookingDetails.passengers)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
