...
const CheckoutPage = () => {
  ...
  const totalPrice = (bookingDetails.price * bookingDetails.passengers) + bookingDetails.tax + bookingDetails.serviceFee;
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Lengkapi pembayaran untuk menyelesaikan pemesanan Anda</p>
          </div>
