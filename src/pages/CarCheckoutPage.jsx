...
const CarCheckoutPage = () => {
      ...
      <div className="bg-gray-50 min-h-screen flex items-center justify-center">
        <div className="bg-white rounded-xl shadow-md p-8 max-w-md text-center">
          <p className="text-gray-700 mb-4">
            Data pemesanan mobil tidak ditemukan. Silakan pilih mobil terlebih dahulu.
          </p>
          <button className="btn-primary" onClick={() => navigate('/car-rental')}>
  ...
  const { location: loc, startDate, endDate, passengers } = searchData;
  ...
  const basePricePerNight = car.pricePerDay || 0;
    ...
    <div className="bg-gray-50 min-h-screen py-8">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Checkout Sewa Mobil</h1>
            <p className="text-gray-600">Lengkapi pembayaran untuk menyelesaikan pemesanan mobil Anda</p>
          </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Nama di SIM *</label>
                    <input type="text" className="input-field" placeholder="Sesuai SIM" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Nomor SIM *</label>
                    <input type="text" className="input-field" placeholder="Nomor SIM" />
                  </div>
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-gray-700 mb-2">Alamat Penjemputan</label>
                    <input type="text" className="input-field" placeholder="Nama hotel/alamat lengkap" />
                  </div>
                </div>
                <p className="text-xs text-gray-500">
                  Pastikan data SIM sesuai dengan pengemudi yang akan membawa kendaraan.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 sticky top-24">
                ...
                <div className="space-y-3 mb-6 pb-6 border-b">
                  <div className="flex items-start justify-between">
                    ...
                    <span className="text-sm font-medium text-gray-900 flex items-center">
                      <MapPin className="w-4 h-4 mr-1" /> {loc}
                    </span>
                  </div>
                  <div className="flex items-start justify-between">
                    <span className="text-sm text-gray-600">Tanggal</span>
                    <span className="text-sm font-medium text-gray-900 flex flex-col items-end">
                      <span className="flex items-center">
                        <Calendar className="w-4 h-4 mr-1" /> {startDate || 'Belum dipilih'}
                      </span>
                      <span className="flex items-center text-xs text-gray-500">
                        s/d {endDate || 'Belum dipilih'}
                      </span>
                    </span>
                  </div>
                  <div className="flex items-start justify-between">
                    <span className="text-sm text-gray-600">Durasi</span>
                    <span className="text-sm font-medium text-gray-900">{nights} hari</span>
                  </div>
                  <div className="flex items-start justify-between">
                    <span className="text-sm text-gray-600">Mobil</span>
                    <span className="text-sm font-medium text-gray-900 flex flex-col items-end">
                      <span className="flex items-center">
                        <Car className="w-4 h-4 mr-1" /> {car.name}
                      </span>
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <span className="text-sm font-medium text-gray-900 flex items-center">
                      <Users className="w-4 h-4 mr-1" /> {car.passengers} penumpang
                    </span>
                  </div>
                  <div className="flex items-start justify-between">
                    <span className="text-sm text-gray-600">Transmisi / Bahan Bakar</span>
                    <span className="text-sm font-medium text-gray-900 flex items-center">
                      <Gauge className="w-4 h-4 mr-1" /> {car.transmission} • <Fuel className="w-4 h-4 mx-1" />
                      {car.fuel}
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Harga per hari x {nights}</span>
                    <span className="text-sm font-medium text-gray-900">
                      {formatPrice(basePricePerNight * nights)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                ...
                <div className="pt-6 border-t">
                  ...
                  <p className="mt-4 text-xs text-gray-500">
                    Harga belum termasuk biaya tol dan parkir. Harap menunjukkan SIM asli saat pengambilan kendaraan.
                  </p>
                </div>
              </div>
            </div>
